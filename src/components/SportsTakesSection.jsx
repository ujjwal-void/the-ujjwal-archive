...
import { Flame, Lightbulb, Activity } from 'lucide-react';
    ...
    <div>
      <div style={{ marginBottom: '2.5rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '0.4rem' }}>
          <span className="meta-tag meta-amber">SPORTS TELEMETRY & TACTICS</span>
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.75rem', color: 'var(--text-dim)' }}>[SYSTEM_PARALLELS: ACTIVE]</span>
        </div>
        <h2 style={{ fontSize: '2.2rem', marginBottom: '0.4rem' }}>⚽ Tactical Board & Sports News</h2>
          ...
          <div key={take.id} className="card">
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.8rem', flexWrap: 'wrap', gap: '0.5rem' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', background: 'rgba(255,255,255,0.03)', padding: '0.3rem 0.8rem', borderRadius: 'var(--radius-sm)', border: '1px solid var(--glass-border)' }}>
                <span style={{ fontSize: '0.78rem', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)' }}>HYPE_SCORE:</span>
                <span style={{ fontSize: '0.85rem', fontWeight: 800, color: 'var(--accent-rose)', display: 'flex', alignItems: 'center', gap: '0.2rem', fontFamily: 'var(--font-mono)' }}>
                  {take.hypeScore}/100 <Flame size={14} />
                </span>
              </div>
            </div>

            <h3 style={{ fontSize: '1.45rem', marginBottom: '0.8rem' }}>{take.title}</h3>
            ...
            <div style={{ background: 'rgba(7, 10, 16, 0.7)', padding: '1.2rem', borderRadius: 'var(--radius-sm)', borderLeft: '3px solid var(--accent-amber)', marginBottom: '1rem' }}>
              <h4 style={{ fontSize: '0.78rem', color: 'var(--accent-amber)', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.4rem', fontFamily: 'var(--font-mono)' }}>[TACTICAL_ANALYSIS]</h4>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', background: 'rgba(52, 211, 153, 0.05)', padding: '0.9rem 1.1rem', borderRadius: 'var(--radius-sm)', border: '1px solid rgba(52, 211, 153, 0.2)' }}>
              <Activity size={22} style={{ color: 'var(--accent-emerald)', flexShrink: 0 }} />
              <div>
                <span style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--accent-emerald)', textTransform: 'uppercase', fontFamily: 'var(--font-mono)' }}>ENGINEERING PARALLEL:</span>
